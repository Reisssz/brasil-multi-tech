...
const produtosMock: ProdutoMock[] = [
  {
    ...
    variants: [
      {
        id: "v-iphone11-white-64-excelente",
        color: "Branco",
        colorHex: "#f2f1ec",
        storageGb: 64,
        condition: "excelente",
      ...
      {
        id: "v-iphone11-white-64-muito-bom",
        color: "Branco",
        colorHex: "#f2f1ec",
        storageGb: 64,
        condition: "muito-bom",
  ...
  },
  {
    ...
    variants: [
      {
        id: "v-iphone11promax-gray-256-excelente",
      ...
      {
        id: "v-iphone11promax-gray-256-muito-bom",
        color: "Cinza espacial",
        colorHex: "#4b4d50",
        storageGb: 256,
        condition: "muito-bom",
        priceCents: 234900,
        compareAtCents: 279900,
        stock: 4,
        images: ["phone", "phone"],
        photos: ["iphone11promax-gray-1.jpeg"],
      },
      {
        id: "v-iphone11promax-gray-256-bom",
        color: "Cinza espacial",
        colorHex: "#4b4d50",
        storageGb: 256,
        condition: "bom",
      ...
      {
        id: "v-iphone11promax-gray-256-outlet",
        color: "Cinza espacial",
        colorHex: "#4b4d50",
        storageGb: 256,
        condition: "outlet",
  ...
  },
  {
    ...
    variants: [
      {
        id: "v-iphone12-black-128-excelente",
        color: "Preto",
        colorHex: "#1c1c1e",
        storageGb: 128,
        condition: "excelente",
      ...
      {
        id: "v-iphone12-black-128-muito-bom",
        color: "Preto",
        colorHex: "#1c1c1e",
        storageGb: 128,
        condition: "muito-bom",
      ...
      {
        id: "v-iphone12-black-128-outlet",
        color: "Preto",
        colorHex: "#1c1c1e",
        storageGb: 128,
        condition: "outlet",
  ...
  },
  {
    ...
    variants: [
      {
        id: "v-iphone13-midnight-128-excelente",
        color: "Meia-noite",
        colorHex: "#1c1e26",
        storageGb: 128,
        condition: "excelente",
      ...
      {
        id: "v-iphone13-midnight-128-muito-bom",
        color: "Meia-noite",
        colorHex: "#1c1e26",
        storageGb: 128,
        condition: "muito-bom",
      ...
      {
        id: "v-iphone13-midnight-128-bom",
        color: "Meia-noite",
        colorHex: "#1c1e26",
        storageGb: 128,
        condition: "bom",
      ...
      {
        id: "v-iphone13-midnight-128-outlet",
        color: "Meia-noite",
        colorHex: "#1c1e26",
        storageGb: 128,
        condition: "outlet",
      ...
      {
        id: "v-iphone13-blue-256-muito-bom",
        color: "Azul",
        colorHex: "#4f6d9a",
        storageGb: 256,
        condition: "muito-bom",
  ...
  },
  {
    ...
    variants: [
      ...
      {
        id: "v-s23-green-256-muito-bom",
        color: "Verde",
        colorHex: "#8a9a7e",
        storageGb: 256,
        condition: "muito-bom",
        priceCents: 261900,
        compareAtCents: 309900,
        stock: 6,
        images: ["phone", "phone"],
      },
      {
        id: "v-s23-green-256-bom",
        color: "Verde",
        colorHex: "#8a9a7e",
        storageGb: 256,
        condition: "bom",
