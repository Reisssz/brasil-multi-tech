...
function Chevron() {
  return (
    <svg width="10" height="10" viewBox="0 0 12 12" fill="none" className="text-ink-muted/70 group-hover:text-brand transition-colors">
...
export function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-40 bg-ink/95 backdrop-blur border-b border-ink-border transition-shadow duration-300 ${
        ...
        <nav className="hidden lg:flex items-center gap-5 h-11 -mt-1 border-t border-ink-border/70 text-sm overflow-x-auto">
          ...
          {categories.map((c) => (
            <Link
              ...
              className="group flex items-center gap-1 shrink-0 whitespace-nowrap text-ink-muted hover:text-brand font-medium transition-colors"
            >
              {c.shortLabel}
              <Chevron />
            </Link>
          ))}
          <Link href="/categoria/ofertas" className="shrink-0 whitespace-nowrap text-brand font-semibold ml-auto">
            Ofertas
          </Link>
          ...
          <Link href="/contato" className="shrink-0 whitespace-nowrap text-ink-muted hover:text-brand font-medium transition-colors">
            Contato
          </Link>
        </nav>
      </div>
