  ...
  return (
    <div className="fixed z-50 bottom-4 right-4 sm:bottom-6 sm:right-6 flex flex-col items-end gap-2 pb-[env(safe-area-inset-bottom)]">
      ...
      <a
        ...
        className="animate-pop-in group relative flex items-center justify-center w-14 h-14 rounded-full bg-whatsapp text-whatsapp-foreground shadow-[0_8px_20px_rgba(37,211,102,0.45)] transition-transform hover:scale-110 active:scale-95"
      >
